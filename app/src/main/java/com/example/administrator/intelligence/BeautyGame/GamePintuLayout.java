package com.example.administrator.intelligence.BeautyGame;
...
public class GamePintuLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private int[] Beauty_Image = new int[]{R.mipmap.beauty_image1, R.mipmap.beauty_image2, R.mipmap.beauty_image3, R.mipmap.beauty_image4};
    ...
    private void initBitmap() {
        if (mBitmap == null) {
            mBitmap = BitmapFactory.decodeResource(getResources(), Beauty_Image[createNumber()]);
    ...
    private int createNumber() {
        ...
        int randomNumber = random.nextInt(3) % (3 - 0 + 1) + 0;
        return randomNumber;
    }
    ...
    private void checkSuccess() {
        ...
        if (isSuccess) {
            Toast.makeText(getContext(), "成功晋级!",
                    Toast.LENGTH_LONG).show();
            EventBus.getDefault().post(new ViewEvent(EventsID.SUCCESS_NEXTLEVEL));
            nextLevel();
        }
    }
