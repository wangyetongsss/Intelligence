...
public class PermissionsUtils {
    ...
    //TODO 请求运行时权限
    public void requestRuntimePermissions(String[] permission) {
    ...
    private void showApplySnackbar(final String[] permission) {
        ...
        Snackbar snackbar = Snackbar.make(view, R.string.str_no_permissions_tip,
                ...
                .setActionTextColor(getActivity().getResources().getColor(R.color.main_color_098dbe))
